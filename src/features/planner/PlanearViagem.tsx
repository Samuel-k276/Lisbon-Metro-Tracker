      ...
      {resultados && (
        <Paper elevation={3} sx={{ p: 3 }}>
          ...
          <Box sx={{ display: "flex", flexWrap: "wrap", gap: 2, mb: 3 }}>
            ...
            >
              ...
              <Box>
                ...
                <Typography variant="h6">{resultados.tempoTotal} min</Typography>
              </Box>
            </Box>
            ...
            >
              ...
              <Box>
                ...
                <Typography variant="h6">{resultados.estacoes}</Typography>
              </Box>
            </Box>
            ...
            >
              ...
              <Box>
                ...
                <Typography variant="h6">{resultados.trocasLinha}</Typography>
              </Box>
            </Box>
          </Box>
                    ...
                    <ListItemText
                      primary={
                        <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                          <Typography variant="body1">Mudança de Linha:</Typography>
                          <Chip
                            label={etapa.de}
                            size="small"
                            sx={{
          ...
          <Box sx={{ mt: 3, p: 2, backgroundColor: "#e8f5e9", borderRadius: 1 }}>
            <Typography variant="body2" color="text.secondary">
              <strong>Nota:</strong> Este é um planeador conceptual. Os tempos são estimativas e
              podem variar consoante o horário, ocupação das estações e outros fatores. Este sistema
              não tem em conta horários específicos de operação ou possíveis perturbações no
              serviço.
            </Typography>
          </Box>
        </Paper>
